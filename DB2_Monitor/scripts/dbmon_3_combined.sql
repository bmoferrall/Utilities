...
ECHO ************************************;
ECHO TAKING DUBPERF_DB END SNAPSHOT;
ECHO ************************************;
INSERT INTO DBMON.DUBPERF_DB_END SELECT * FROM SYSIBMADM.SNAPDB;

ECHO ****************************************************;
ECHO NEW MAR15: Taking DUBPERF_MONTABLESPACE End Snapshot;
ECHO ****************************************************;


INSERT INTO DBMON.DUBPERF_MONTABLESPACE_END
(
	END_TIMESTAMP		,
	TBSP_NAME		,
	TBSP_ID 		,
...
ECHO ************************************;
ECHO TAKING DBMON.DUBPERF_MONCONTAINER END SNAPSHOT;
ECHO ************************************;
INSERT INTO  DBMON.DUBPERF_MONCONTAINER_END
(
	END_TIMESTAMP
...
ECHO ************************************;
ECHO TAKING DUBPERF_MONINDEX END SNAPSHOT;
ECHO ************************************;
INSERT INTO  DBMON.DUBPERF_MONINDEX_END
(
	SNAP_TIMESTAMP 	,
	TABSCHEMA 		,
	TABNAME 		,
...
ECHO ************************************;
ECHO TAKING DUBPERF_MONTABLE END SNAPSHOT;
ECHO ************************************;
INSERT INTO  DBMON.DUBPERF_MONTABLE_END
(
	END_TIMESTAMP 		,
	TABSCHEMA 		,
	TABNAME 		,
...
COMMIT;
ECHO ************************************;
ECHO END OF DUBPERF END SNAPSHOTS;
ECHO ************************************;
