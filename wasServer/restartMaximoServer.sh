...
usage() {
   ...
   echo ">>>> ${msg} <<<<<<"
   echo "------------------------------------------------------------------------------------"
   echo "Usage:   ./restartMaximoServer.sh -p wasadmin_password -h"
   echo "   Required:"
   ...
   echo "      -h: usage"
   echo "   "
   echo "Example: ./restartMaximoServer.sh -p P33kachu!"
   echo "------------------------------------------------------------------------------------"
   exit 1
}
...
./wsadmin.sh -user wasadmin -password ${password} -lang jython -f ${scriptLocation}/wasMaximoCommand.py -a restart -s ${server} -n ${node} -l ${cell}
